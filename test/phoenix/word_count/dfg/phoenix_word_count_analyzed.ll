; ModuleID = '/mnt/hgfs/graduate/LLVM/llvm-project-19/llvm-project/FieldAnalysis/test/phoenix/word_count/dfg/phoenix_word_count.ll'
...
define dso_local range(i32 -1, 2) i32 @wordcount_cmp(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) #0 !dbg !113 {
  ...
  call void @__record_field_access_full(i32 0, ptr %3, i32 0), !dbg !126
  ...
  call void @__record_field_access_full(i32 0, ptr %5, i32 0), !dbg !133
...
define dso_local void @wordcount_splitter(ptr nocapture noundef readonly %0) local_unnamed_addr #2 !dbg !138 {
  ...
  call void @__record_field_access_full(i32 1, ptr @words, i32 1), !dbg !148
  store ptr %2, ptr @words, align 8, !dbg !148, !tbaa !149
  call void @__record_field_access_full(i32 2, ptr @length, i32 1), !dbg !150
  store i32 2000, ptr @length, align 4, !dbg !150, !tbaa !151
  call void @__record_field_access_full(i32 2, ptr @use_len, i32 1), !dbg !152
...
3:                                                ; preds = %3, %1
  ...
  call void @__record_field_access_full(i32 0, ptr %5, i32 1), !dbg !157
  ...
  call void @__record_field_access_full(i32 0, ptr %7, i32 1), !dbg !157
  ...
  call void @__record_field_access_full(i32 0, ptr %9, i32 1), !dbg !157
  ...
  call void @__record_field_access_full(i32 0, ptr %11, i32 1), !dbg !157
  ...
  call void @__record_field_access_full(i32 0, ptr %13, i32 1), !dbg !157
...
16:                                               ; preds = %3
  ...
  call void @__record_field_access_full(i32 0, ptr %18, i32 0), !dbg !164
  %19 = load ptr, ptr %18, align 8, !dbg !164, !tbaa !165
  %20 = getelementptr inbounds i8, ptr %17, i64 8, !dbg !168
  call void @__record_field_access_full(i32 0, ptr %20, i32 1), !dbg !169
  store ptr %19, ptr %20, align 8, !dbg !169, !tbaa !170
  call void @__record_field_access_full(i32 3, ptr %0, i32 0), !dbg !172
  %21 = load i64, ptr %0, align 8, !dbg !172, !tbaa !173
  %22 = trunc i64 %21 to i32, !dbg !174
  call void @__record_field_access_full(i32 3, ptr %17, i32 1), !dbg !175
...
4:                                                ; preds = %1
  ...
  call void @__record_field_access_full(i32 0, ptr %5, i32 0), !dbg !209
...
8:                                                ; preds = %4
  ...
  call void @__record_field_access_full(i32 3, ptr %0, i32 0), !dbg !214
...
14:                                               ; preds = %40, %11
  ...
  call void @__record_field_access_full(i32 1, ptr %12, i32 0), !dbg !217
  %18 = load ptr, ptr %12, align 8, !dbg !217, !tbaa !149
  %19 = getelementptr inbounds i8, ptr %6, i64 %15, !dbg !217
  call void @__record_field_access_full(i32 4, ptr %19, i32 1), !dbg !217
  ...
  call void @__record_field_access_full(i32 5, ptr %22, i32 0), !dbg !217
...
49:                                               ; preds = %48
  ...
  call void @__record_field_access_full(i32 4, ptr %51, i32 1), !dbg !245
...
define dso_local void @wordcount_addword(ptr noundef %0, i32 %1) local_unnamed_addr #2 !dbg !264 {
  ...
  call void @__record_field_access_full(i32 2, ptr @use_len, i32 0), !dbg !283
  ...
  call void @__record_field_access_full(i32 1, ptr @words, i32 0), !dbg !285
...
6:                                                ; preds = %16, %2
  ...
  call void @__record_field_access_full(i32 3, ptr %12, i32 0), !dbg !293
...
25:                                               ; preds = %22, %2
  ...
  call void @__record_field_access_full(i32 3, ptr %27, i32 1), !dbg !306
  store ptr %0, ptr %27, align 8, !dbg !306, !tbaa !294
  call void @__record_field_access_full(i32 1, ptr @words, i32 0), !dbg !307
  %28 = load ptr, ptr @words, align 8, !dbg !307, !tbaa !149
  %29 = getelementptr inbounds %struct.wc_count_t, ptr %28, i64 %26, i32 1, !dbg !308
  call void @__record_field_access_full(i32 0, ptr %29, i32 1), !dbg !309
  store i32 1, ptr %29, align 8, !dbg !309, !tbaa !127
  call void @__record_field_access_full(i32 2, ptr @use_len, i32 0), !dbg !310
  %30 = load i32, ptr @use_len, align 4, !dbg !310, !tbaa !151
  %31 = add nsw i32 %30, 1, !dbg !310
  call void @__record_field_access_full(i32 2, ptr @use_len, i32 1), !dbg !310
...
34:                                               ; preds = %32
  ...
  call void @__record_field_access_full(i32 6, ptr %35, i32 0), !dbg !317
  ...
  call void @__record_field_access_full(i32 3, ptr %5, i32 1), !dbg !320
  store ptr %0, ptr %5, align 8, !dbg !320, !tbaa !294
  call void @__record_field_access_full(i32 1, ptr @words, i32 0), !dbg !321
  %38 = load ptr, ptr @words, align 8, !dbg !321, !tbaa !149
  %39 = getelementptr inbounds i8, ptr %38, i64 8, !dbg !322
  call void @__record_field_access_full(i32 0, ptr %39, i32 1), !dbg !323
  store i32 1, ptr %39, align 8, !dbg !323, !tbaa !127
  %40 = add nuw nsw i32 %3, 1, !dbg !324
  call void @__record_field_access_full(i32 2, ptr @use_len, i32 1), !dbg !324
...
41:                                               ; preds = %32
  ...
  call void @__record_field_access_full(i32 3, ptr %43, i32 0), !dbg !328
...
47:                                               ; preds = %41
  ...
  call void @__record_field_access_full(i32 0, ptr %48, i32 0), !dbg !334
  %49 = load i32, ptr %48, align 8, !dbg !334, !tbaa !127
  %50 = add nsw i32 %49, 1, !dbg !334
  store i32 %50, ptr %48, align 8, !dbg !334, !tbaa !127
  call void @__record_field_access_full(i32 2, ptr @use_len, i32 0), !dbg !335
...
68:                                               ; preds = %63
  ...
  call void @__record_field_access_full(i32 2, ptr @length, i32 1), !dbg !353
  ...
  call void @__record_field_access_full(i32 1, ptr @words, i32 1), !dbg !358
...
define dso_local i32 @dobsearch(ptr nocapture noundef readonly %0) local_unnamed_addr #8 !dbg !273 {
  ...
  call void @__record_field_access_full(i32 2, ptr @use_len, i32 0), !dbg !362
...
4:                                                ; preds = %1
  call void @__record_field_access_full(i32 1, ptr @words, i32 0)
...
6:                                                ; preds = %16, %4
  ...
  call void @__record_field_access_full(i32 3, ptr %12, i32 0), !dbg !368
...
define dso_local noundef i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #2 !dbg !384 {
  ...
  call void @__record_field_access_full(i32 4, ptr %4, i32 0), !dbg !442
  %5 = load ptr, ptr %4, align 8, !dbg !442, !tbaa !149
  %6 = icmp eq ptr %5, null, !dbg !444
  br i1 %6, label %7, label %10, !dbg !445

7:                                                ; preds = %2
  call void @__record_field_access_full(i32 1, ptr %1, i32 0), !dbg !446
...
10:                                               ; preds = %2
  ...
  call void @__record_field_access_full(i32 4, ptr %11, i32 0), !dbg !450
...
21:                                               ; preds = %17
  ...
  call void @__record_field_access_full(i32 7, ptr %22, i32 0), !dbg !462
...
35:                                               ; preds = %30, %28
  ...
  call void @__record_field_access_full(i32 1, ptr @words, i32 1), !dbg !488
  store ptr %37, ptr @words, align 8, !dbg !488, !tbaa !149
  call void @__record_field_access_full(i32 2, ptr @length, i32 1), !dbg !489
  store i32 2000, ptr @length, align 4, !dbg !489, !tbaa !151
  call void @__record_field_access_full(i32 2, ptr @use_len, i32 1), !dbg !490
...
38:                                               ; preds = %38, %35
  ...
  call void @__record_field_access_full(i32 0, ptr %40, i32 1), !dbg !493
  ...
  call void @__record_field_access_full(i32 0, ptr %42, i32 1), !dbg !493
  ...
  call void @__record_field_access_full(i32 0, ptr %44, i32 1), !dbg !493
  ...
  call void @__record_field_access_full(i32 0, ptr %46, i32 1), !dbg !493
  ...
  call void @__record_field_access_full(i32 0, ptr %48, i32 1), !dbg !493
...
51:                                               ; preds = %38
  ...
  call void @__record_field_access_full(i32 0, ptr %53, i32 1), !dbg !500
  store ptr %25, ptr %53, align 8, !dbg !500, !tbaa !170
  %54 = trunc i64 %23 to i32, !dbg !501
  call void @__record_field_access_full(i32 3, ptr %52, i32 1), !dbg !502
  ...
  call void @__record_field_access_full(i32 1, ptr @words, i32 0), !dbg !505
  %55 = load ptr, ptr @words, align 8, !dbg !505, !tbaa !149
  call void @__record_field_access_full(i32 2, ptr @use_len, i32 0), !dbg !506
  ...
  call void @__record_field_access_full(i32 1, ptr @words, i32 0), !dbg !508
