; ModuleID = '/mnt/hgfs/graduate/LLVM/llvm-project-19/llvm-project/FieldAnalysis/test/phoenix/linear_regression/linear_regression_pthread.c'
...
define dso_local noundef i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #2 !dbg !435 {
  ...
  call void @llvm.lifetime.start.p0(i64 144, ptr nonnull %3) #14, !dbg !526
  call void @llvm.lifetime.start.p0(i64 56, ptr nonnull %4) #14, !dbg !527
...
9:                                                ; preds = %2
  ...
  tail call void @exit(i32 noundef 1) #15, !dbg !536
  unreachable, !dbg !536

12:                                               ; preds = %2
    #dbg_value(ptr %7, !445, !DIExpression(), !522)
  %13 = tail call i32 (ptr, i32, ...) @open(ptr noundef nonnull %7, i32 noundef 0) #14, !dbg !537
    #dbg_value(i32 %13, !443, !DIExpression(), !522)
  %14 = icmp slt i32 %13, 0, !dbg !537
  br i1 %14, label %15, label %16, !dbg !539

15:                                               ; preds = %12
  tail call void @perror(ptr noundef nonnull @.str.1) #16, !dbg !540
  tail call void @exit(i32 noundef 1) #15, !dbg !540
  unreachable, !dbg !540

16:                                               ; preds = %12
  %17 = call i32 @fstat(i32 noundef %13, ptr noundef nonnull %3) #14, !dbg !542
  %18 = icmp slt i32 %17, 0, !dbg !542
  br i1 %18, label %19, label %20, !dbg !544

19:                                               ; preds = %16
  tail call void @perror(ptr noundef nonnull @.str.2) #16, !dbg !545
  tail call void @exit(i32 noundef 1) #15, !dbg !545
  unreachable, !dbg !545
...
20:                                               ; preds = %16
  ...
  %24 = tail call ptr @mmap(ptr noundef null, i64 noundef %23, i32 noundef 3, i32 noundef 2, i32 noundef %13, i64 noundef 0) #14, !dbg !547
    #dbg_value(ptr %24, !444, !DIExpression(), !522)
  %25 = icmp eq ptr %24, null, !dbg !547
  br i1 %25, label %26, label %27, !dbg !552

26:                                               ; preds = %20
  tail call void @perror(ptr noundef nonnull @.str.3) #16, !dbg !553
  tail call void @exit(i32 noundef 1) #15, !dbg !553
  unreachable, !dbg !553

27:                                               ; preds = %20
  %28 = tail call i64 @sysconf(i32 noundef 84) #14, !dbg !555
...
31:                                               ; preds = %27
  tail call void @perror(ptr noundef nonnull @.str.4) #16, !dbg !558
  tail call void @exit(i32 noundef 1) #15, !dbg !558
  unreachable, !dbg !558

32:                                               ; preds = %27
  %33 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %29), !dbg !560
  %34 = call i32 @pthread_attr_init(ptr noundef nonnull %4) #14, !dbg !561
  %35 = call i32 @pthread_attr_setscope(ptr noundef nonnull %4, i32 noundef 0) #14, !dbg !562
  ...
  %41 = call noalias ptr @calloc(i64 noundef 64, i64 noundef %38) #17, !dbg !579
...
50:                                               ; preds = %32
  call void @__assert_fail(ptr noundef nonnull @.str.24, ptr noundef nonnull @.str.25, i32 noundef 53, ptr noundef nonnull @__PRETTY_FUNCTION__.CALLOC) #15, !dbg !580
  unreachable, !dbg !580
...
57:                                               ; preds = %43, %51
  ...
  %68 = call i32 @pthread_create(ptr noundef nonnull %61, ptr noundef nonnull %4, ptr noundef nonnull @linear_regression_pthread, ptr noundef nonnull %61) #14, !dbg !604
...
70:                                               ; preds = %57
  call void @perror(ptr noundef nonnull @.str.7) #16, !dbg !607
  call void @exit(i32 noundef 1) #15, !dbg !607
  unreachable, !dbg !607
...
71:                                               ; preds = %54, %87
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %5) #14, !dbg !609
  %78 = getelementptr inbounds %struct.lreg_args, ptr %41, i64 %72, !dbg !610
  %79 = load i64, ptr %78, align 8, !dbg !610, !tbaa !612
  %80 = call i32 @pthread_join(i64 noundef %79, ptr noundef nonnull %5) #14, !dbg !610
  %81 = icmp eq i32 %80, 0, !dbg !610
  br i1 %81, label %83, label %82, !dbg !613

82:                                               ; preds = %71
  call void @perror(ptr noundef nonnull @.str.8) #16, !dbg !614
  call void @exit(i32 noundef 1) #15, !dbg !614
  unreachable, !dbg !614
...
86:                                               ; preds = %83
  call void @perror(ptr noundef nonnull @.str.9) #16, !dbg !620
  call void @exit(i32 noundef 1) #15, !dbg !620
  unreachable, !dbg !620
...
87:                                               ; preds = %83
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %5) #14, !dbg !632
...
105:                                              ; preds = %87
  call void @free(ptr noundef nonnull %41) #14, !dbg !636
  ...
  %140 = call i32 @pthread_attr_destroy(ptr noundef nonnull %4) #14, !dbg !665
  %141 = icmp slt i32 %140, 0, !dbg !665
  br i1 %141, label %142, label %143, !dbg !667

142:                                              ; preds = %105
  call void @perror(ptr noundef nonnull @.str.21) #16, !dbg !668
  call void @exit(i32 noundef 1) #15, !dbg !668
  unreachable, !dbg !668

143:                                              ; preds = %105
  %144 = call i32 @munmap(ptr noundef nonnull %24, i64 noundef %23) #14, !dbg !670
  %145 = icmp slt i32 %144, 0, !dbg !670
  br i1 %145, label %146, label %147, !dbg !672

146:                                              ; preds = %143
  call void @perror(ptr noundef nonnull @.str.22) #16, !dbg !673
  call void @exit(i32 noundef 1) #15, !dbg !673
  unreachable, !dbg !673

147:                                              ; preds = %143
  %148 = call i32 @close(i32 noundef %13) #14, !dbg !675
  %149 = icmp slt i32 %148, 0, !dbg !675
  br i1 %149, label %150, label %151, !dbg !677

150:                                              ; preds = %147
  call void @perror(ptr noundef nonnull @.str.23) #16, !dbg !678
  call void @exit(i32 noundef 1) #15, !dbg !678
  unreachable, !dbg !678

151:                                              ; preds = %147
  call void @llvm.lifetime.end.p0(i64 56, ptr nonnull %4) #14, !dbg !680
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %3) #14, !dbg !680
  ret i32 0, !dbg !681
}
