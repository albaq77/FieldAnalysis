; ModuleID = '/mnt/hgfs/graduate/LLVM/llvm-project-19/llvm-project/FieldAnalysis/test/phoenix/histogram/dfg/phoenix_histogram.ll'
...
define dso_local void @test_endianess() local_unnamed_addr #0 !dbg !340 {
  ...
  call void @__record_field_access_full(i32 0, ptr @swap, i32 1), !dbg !347
...
4:                                                ; preds = %2
  ...
  call void @__record_field_access_full(i32 1, ptr %8, i32 0), !dbg !378
...
13:                                               ; preds = %13, %11
  ...
  call void @__record_field_access_full(i32 1, ptr %16, i32 1), !dbg !379
  ...
  call void @__record_field_access_full(i32 1, ptr %19, i32 0), !dbg !383
  ...
  call void @__record_field_access_full(i32 1, ptr %22, i32 1), !dbg !379
  ...
  call void @__record_field_access_full(i32 1, ptr %25, i32 0), !dbg !383
...
33:                                               ; preds = %30
  ...
  call void @__record_field_access_full(i32 1, ptr %34, i32 1), !dbg !379
  ...
  call void @__record_field_access_full(i32 1, ptr %37, i32 0), !dbg !383
...
define dso_local noalias noundef ptr @calc_hist(ptr nocapture noundef %0) #5 !dbg !391 {
  ...
  call void @__record_field_access_full(i32 1, ptr %2, i32 0), !dbg !405
  %3 = getelementptr inbounds i8, ptr %0, i64 1048, !dbg !405
    #dbg_value(ptr %3, !398, !DIExpression(), !403)
  call void @__record_field_access_full(i32 1, ptr %3, i32 0), !dbg !406
  %4 = getelementptr inbounds i8, ptr %0, i64 2072, !dbg !406
    #dbg_value(ptr %4, !399, !DIExpression(), !403)
  call void @__record_field_access_full(i32 1, ptr %4, i32 0), !dbg !407
  %5 = getelementptr inbounds i8, ptr %0, i64 8, !dbg !407
  call void @__record_field_access_full(i32 2, ptr %5, i32 0), !dbg !407
...
15:                                               ; preds = %15, %13
  ...
  call void @__record_field_access_full(i32 1, ptr %17, i32 0), !dbg !421
  %18 = load i8, ptr %17, align 1, !dbg !421, !tbaa !381
  %19 = zext i8 %18 to i64, !dbg !422
  %20 = getelementptr inbounds i32, ptr %4, i64 %19, !dbg !422
  call void @__record_field_access_full(i32 5, ptr %20, i32 0), !dbg !423
  ...
  call void @__record_field_access_full(i32 1, ptr %23, i32 0), !dbg !425
  %24 = load i8, ptr %23, align 1, !dbg !425, !tbaa !381
  %25 = zext i8 %24 to i64, !dbg !426
  %26 = getelementptr inbounds i32, ptr %3, i64 %25, !dbg !426
  call void @__record_field_access_full(i32 5, ptr %26, i32 0), !dbg !427
  ...
  call void @__record_field_access_full(i32 1, ptr %29, i32 0), !dbg !429
  %30 = load i8, ptr %29, align 1, !dbg !429, !tbaa !381
  %31 = zext i8 %30 to i64, !dbg !430
  %32 = getelementptr inbounds i32, ptr %2, i64 %31, !dbg !430
  call void @__record_field_access_full(i32 5, ptr %32, i32 0), !dbg !431
...
define dso_local noundef i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #6 !dbg !436 {
  ...
  call void @__record_field_access_full(i32 1, ptr %8, i32 0), !dbg !517
  %9 = load ptr, ptr %8, align 8, !dbg !517, !tbaa !519
  %10 = icmp eq ptr %9, null, !dbg !520
  br i1 %10, label %11, label %14, !dbg !521

11:                                               ; preds = %2
  call void @__record_field_access_full(i32 6, ptr %1, i32 0), !dbg !522
...
22:                                               ; preds = %18
  ...
  call void @__record_field_access_full(i32 7, ptr %23, i32 0), !dbg !536
...
32:                                               ; preds = %29
  ...
  call void @__record_field_access_full(i32 1, ptr %33, i32 0), !dbg !548
...
38:                                               ; preds = %32
  ...
  call void @__record_field_access_full(i32 0, ptr @swap, i32 1), !dbg !556
  ...
  call void @__record_field_access_full(i32 1, ptr %39, i32 0), !dbg !558
...
45:                                               ; preds = %38
  ...
  call void @__record_field_access_full(i32 1, ptr %46, i32 0), !dbg !569
...
80:                                               ; preds = %80, %72
  ...
  call void @__record_field_access_full(i32 4, ptr %84, i32 1), !dbg !613
  store ptr %26, ptr %84, align 8, !dbg !613, !tbaa !418
  %85 = getelementptr inbounds i8, ptr %84, i64 8, !dbg !614
  call void @__record_field_access_full(i32 2, ptr %85, i32 1), !dbg !615
  ...
  call void @__record_field_access_full(i32 3, ptr %86, i32 1), !dbg !620
  ...
  call void @__record_field_access_full(i32 8, ptr %94, i32 0), !dbg !623
...
101:                                              ; preds = %101, %77
  ...
  call void @__record_field_access_full(i32 8, ptr %103, i32 0), !dbg !631
...
108:                                              ; preds = %136, %98
  ...
  call void @__record_field_access_full(i32 9, ptr %110, i32 0)
...
114:                                              ; preds = %114, %108
  ...
  call void @__record_field_access_full(i32 1, ptr %111, i32 0), !dbg !643
  %116 = getelementptr inbounds [256 x i32], ptr %111, i64 0, i64 %115, !dbg !643
  call void @__record_field_access_full(i32 5, ptr %116, i32 0), !dbg !643
  %117 = load <4 x i32>, ptr %116, align 4, !dbg !643, !tbaa !350
  %118 = getelementptr inbounds [256 x i32], ptr %5, i64 0, i64 %115, !dbg !645
  call void @__record_field_access_full(i32 5, ptr %118, i32 1), !dbg !646
  ...
  call void @__record_field_access_full(i32 1, ptr %112, i32 0), !dbg !647
  %121 = getelementptr inbounds [256 x i32], ptr %112, i64 0, i64 %115, !dbg !647
  call void @__record_field_access_full(i32 5, ptr %121, i32 0), !dbg !647
  %122 = load <4 x i32>, ptr %121, align 4, !dbg !647, !tbaa !350
  %123 = getelementptr inbounds [256 x i32], ptr %6, i64 0, i64 %115, !dbg !648
  call void @__record_field_access_full(i32 5, ptr %123, i32 1), !dbg !649
  ...
  call void @__record_field_access_full(i32 1, ptr %113, i32 0), !dbg !650
  %126 = getelementptr inbounds [256 x i32], ptr %113, i64 0, i64 %115, !dbg !650
  call void @__record_field_access_full(i32 5, ptr %126, i32 0), !dbg !650
  %127 = load <4 x i32>, ptr %126, align 4, !dbg !650, !tbaa !350
  %128 = getelementptr inbounds [256 x i32], ptr %7, i64 0, i64 %115, !dbg !651
  call void @__record_field_access_full(i32 5, ptr %128, i32 1), !dbg !652
