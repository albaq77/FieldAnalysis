; ModuleID = '/mnt/hgfs/graduate/LLVM/llvm-project-19/llvm-project/FieldAnalysis/test/test_suites/locked/dfg/locked_test_suites.ll'
...
define dso_local noalias noundef nonnull ptr @run(ptr nocapture noundef readonly %0) #0 !dbg !64 {
  ...
  call void @__record_field_access_full(i32 0, ptr %0, i32 0), !dbg !80
...
5:                                                ; preds = %1
  ...
  call void @__record_field_access_full(i32 1, ptr %8, i32 0), !dbg !88
  %9 = sext i32 %2 to i64, !dbg !88
  call void @__record_field_access_full(i32 0, ptr @ITER, i32 0), !dbg !89
...
15:                                               ; preds = %11
  ...
  call void @__record_field_access_full(i32 2, ptr @dynMemory, i32 0), !dbg !95
  ...
  call void @__record_field_access_full(i32 3, ptr %18, i32 1), !dbg !98
  store i32 0, ptr %18, align 4, !dbg !98, !tbaa !81
  %19 = getelementptr i8, ptr %18, i64 16, !dbg !99
  call void @__record_field_access_full(i32 4, ptr %19, i32 1), !dbg !100
  store i32 0, ptr %19, align 4, !dbg !100, !tbaa !81
  %20 = getelementptr i8, ptr %18, i64 32, !dbg !101
  call void @__record_field_access_full(i32 4, ptr %20, i32 1), !dbg !102
  store i32 0, ptr %20, align 4, !dbg !102, !tbaa !81
    #dbg_value(i32 poison, !76, !DIExpression(), !94)
  %21 = getelementptr i8, ptr %18, i64 48, !dbg !103
    #dbg_value(i32 0, !76, !DIExpression(), !94)
  call void @__record_field_access_full(i32 4, ptr %21, i32 1), !dbg !104
...
30:                                               ; preds = %30, %15
  ...
  call void @__record_field_access_full(i32 3, ptr %34, i32 1), !dbg !95
  ...
  call void @__record_field_access_full(i32 4, ptr %40, i32 0), !dbg !99
  ...
  call void @__record_field_access_full(i32 4, ptr %43, i32 0), !dbg !101
  ...
  call void @__record_field_access_full(i32 4, ptr %46, i32 0), !dbg !103
...
6:                                                ; preds = %2
  ...
  call void @__record_field_access_full(i32 4, ptr %7, i32 0), !dbg !170
  ...
  call void @__record_field_access_full(i32 0, ptr @ITER, i32 1), !dbg !181
...
11:                                               ; preds = %6, %2
  ...
  call void @__record_field_access_full(i32 2, ptr @dynMemory, i32 1), !dbg !184
  ...
  call void @__record_field_access_full(i32 4, ptr %14, i32 0), !dbg !188
  call void @__record_field_access_full(i32 5, ptr getelementptr inbounds (i8, ptr @ownThreadLock, i64 2560), i32 0), !dbg !188
  ...
  call void @__record_field_access_full(i32 4, ptr %16, i32 0), !dbg !188
  call void @__record_field_access_full(i32 5, ptr getelementptr inbounds (i8, ptr @ownThreadLock, i64 5120), i32 0), !dbg !188
  ...
  call void @__record_field_access_full(i32 4, ptr %18, i32 0), !dbg !192
  call void @__record_field_access_full(i32 6, ptr %4, i32 1), !dbg !192
  store <4 x i32> <i32 0, i32 1, i32 2, i32 3>, ptr %4, align 16, !dbg !192, !tbaa !81
  call void @__record_field_access_full(i32 5, ptr getelementptr inbounds (i8, ptr @ownThreadLock, i64 7680), i32 0), !dbg !188
  ...
  call void @__record_field_access_full(i32 4, ptr %21, i32 0), !dbg !194
  ...
  call void @__record_field_access_full(i32 4, ptr %23, i32 0), !dbg !194
  ...
  call void @__record_field_access_full(i32 4, ptr %25, i32 0), !dbg !194
  ...
  call void @__record_field_access_full(i32 7, ptr %3, i32 0), !dbg !199
