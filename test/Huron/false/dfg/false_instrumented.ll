; ModuleID = '/mnt/hgfs/graduate/LLVM/llvm-project-19/llvm-project/FieldAnalysis/test/Huron/false/dfg/false.ll'
...
define dso_local double @compute(i64 %0, i64 %1, i64 %2, i64 %3) #0 !dbg !47 {
  ...
  call void @__record_field_access_full(i32 0, ptr %8, i32 1)
  store i64 %0, ptr %8, align 8
  %9 = getelementptr inbounds { i64, i64 }, ptr %5, i32 0, i32 1
  call void @__record_field_access_full(i32 1, ptr %9, i32 1)
  store i64 %1, ptr %9, align 8
  %10 = getelementptr inbounds { i64, i64 }, ptr %6, i32 0, i32 0
  call void @__record_field_access_full(i32 0, ptr %10, i32 1)
  store i64 %2, ptr %10, align 8
  %11 = getelementptr inbounds { i64, i64 }, ptr %6, i32 0, i32 1
  call void @__record_field_access_full(i32 1, ptr %11, i32 1)
  ...
  call void @__record_field_access_full(i32 0, ptr %12, i32 0), !dbg !58
  %13 = load i64, ptr %12, align 8, !dbg !58
  %14 = getelementptr inbounds %struct.timespec, ptr %5, i32 0, i32 0, !dbg !59
  call void @__record_field_access_full(i32 0, ptr %14, i32 0), !dbg !59
  ...
  call void @__record_field_access_full(i32 0, ptr %19, i32 0), !dbg !64
  %20 = load i64, ptr %19, align 8, !dbg !64
  %21 = getelementptr inbounds %struct.timespec, ptr %5, i32 0, i32 1, !dbg !65
  call void @__record_field_access_full(i32 0, ptr %21, i32 0), !dbg !65
...
12:                                               ; preds = %9
  ...
  call void @__record_field_access_full(i32 2, ptr %16, i32 1), !dbg !94
...
12:                                               ; preds = %9
  ...
  call void @__record_field_access_full(i32 2, ptr %16, i32 1), !dbg !126
...
12:                                               ; preds = %9
  ...
  call void @__record_field_access_full(i32 2, ptr %16, i32 1), !dbg !157
...
12:                                               ; preds = %9
  ...
  call void @__record_field_access_full(i32 2, ptr %16, i32 1), !dbg !188
...
21:                                               ; preds = %15
  ...
  call void @__record_field_access_full(i32 3, ptr %26, i32 0), !dbg !229
  ...
  call void @__record_field_access_full(i32 2, ptr %30, i32 1), !dbg !231
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 !dbg !241 {
  ...
  call void @__record_field_access_full(i32 4, ptr %13, i32 0), !dbg !265
  ...
  call void @__record_field_access_full(i32 4, ptr %15, i32 0), !dbg !267
  ...
  call void @__record_field_access_full(i32 4, ptr %17, i32 0), !dbg !269
  ...
  call void @__record_field_access_full(i32 4, ptr %19, i32 0), !dbg !271
...
24:                                               ; preds = %21
  ...
  call void @__record_field_access_full(i32 4, ptr %27, i32 0), !dbg !281
...
33:                                               ; preds = %21
  ...
  call void @__record_field_access_full(i32 1, ptr getelementptr inbounds ({ i64, i64 }, ptr @tpBegin2, i32 0, i32 1), i32 0), !dbg !289
  ...
  call void @__record_field_access_full(i32 1, ptr getelementptr inbounds ({ i64, i64 }, ptr @tpEnd2, i32 0, i32 1), i32 0), !dbg !289
