; ModuleID = '/mnt/hgfs/graduate/LLVM/llvm-project-19/llvm-project/FieldAnalysis/test/test_suites/linear_regression/linear_regression_pthread.c'
...
define dso_local noundef i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #2 !dbg !201 {
  ...
  call void @llvm.lifetime.start.p0(i64 144, ptr nonnull %3) #14, !dbg !301
    #dbg_value(i32 4, !254, !DIExpression(), !296)
  call void @llvm.lifetime.start.p0(i64 56, ptr nonnull %4) #14, !dbg !302
...
10:                                               ; preds = %2
  ...
  tail call void @exit(i32 noundef 1) #15, !dbg !311
  unreachable, !dbg !311

13:                                               ; preds = %2
    #dbg_value(ptr %8, !211, !DIExpression(), !296)
  %14 = tail call i32 (ptr, i32, ...) @open(ptr noundef nonnull %8, i32 noundef 0) #14, !dbg !312
    #dbg_value(i32 %14, !209, !DIExpression(), !296)
  %15 = icmp slt i32 %14, 0, !dbg !312
  br i1 %15, label %16, label %17, !dbg !314

16:                                               ; preds = %13
  tail call void @perror(ptr noundef nonnull @.str.1) #16, !dbg !315
  tail call void @exit(i32 noundef 1) #15, !dbg !315
  unreachable, !dbg !315

17:                                               ; preds = %13
  %18 = call i32 @fstat(i32 noundef %14, ptr noundef nonnull %3) #14, !dbg !317
  %19 = icmp slt i32 %18, 0, !dbg !317
  br i1 %19, label %20, label %21, !dbg !319

20:                                               ; preds = %17
  tail call void @perror(ptr noundef nonnull @.str.2) #16, !dbg !320
  tail call void @exit(i32 noundef 1) #15, !dbg !320
  unreachable, !dbg !320
...
21:                                               ; preds = %17
  ...
  %25 = tail call ptr @mmap(ptr noundef null, i64 noundef %24, i32 noundef 3, i32 noundef 2, i32 noundef %14, i64 noundef 0) #14, !dbg !322
    #dbg_value(ptr %25, !210, !DIExpression(), !296)
  %26 = icmp eq ptr %25, null, !dbg !322
  br i1 %26, label %27, label %28, !dbg !327

27:                                               ; preds = %21
  tail call void @perror(ptr noundef nonnull @.str.3) #16, !dbg !328
  tail call void @exit(i32 noundef 1) #15, !dbg !328
  unreachable, !dbg !328

28:                                               ; preds = %21
  %29 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, i32 noundef 4), !dbg !330
  %30 = call i32 @pthread_attr_init(ptr noundef nonnull %4) #14, !dbg !331
  %31 = call i32 @pthread_attr_setscope(ptr noundef nonnull %4, i32 noundef 0) #14, !dbg !332
  ...
  call void @llvm.lifetime.start.p0(i64 512, ptr nonnull %5) #14, !dbg !338
  ...
  %42 = call i32 @pthread_create(ptr noundef nonnull %5, ptr noundef nonnull %4, ptr noundef nonnull @linear_regression_pthread, ptr noundef nonnull %36) #14, !dbg !347
  %43 = icmp eq i32 %42, 0, !dbg !347
  br i1 %43, label %45, label %44, !dbg !349

44:                                               ; preds = %66, %55, %45, %28
  call void @perror(ptr noundef nonnull @.str.6) #16, !dbg !350
  call void @exit(i32 noundef 1) #15, !dbg !350
  unreachable, !dbg !350
...
45:                                               ; preds = %28
  ...
  %53 = call i32 @pthread_create(ptr noundef nonnull %52, ptr noundef nonnull %4, ptr noundef nonnull @linear_regression_pthread, ptr noundef nonnull %48) #14, !dbg !347
...
55:                                               ; preds = %45
  ...
  %64 = call i32 @pthread_create(ptr noundef nonnull %63, ptr noundef nonnull %4, ptr noundef nonnull @linear_regression_pthread, ptr noundef nonnull %59) #14, !dbg !347
...
66:                                               ; preds = %55
  ...
  %77 = call i32 @pthread_create(ptr noundef nonnull %76, ptr noundef nonnull %4, ptr noundef nonnull @linear_regression_pthread, ptr noundef nonnull %70) #14, !dbg !347
...
79:                                               ; preds = %66
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %6) #14, !dbg !361
  %81 = load i64, ptr %36, align 8, !dbg !362, !tbaa !354
  %82 = call i32 @pthread_join(i64 noundef %81, ptr noundef nonnull %6) #14, !dbg !362
  %83 = icmp eq i32 %82, 0, !dbg !362
  br i1 %83, label %85, label %84, !dbg !364

84:                                               ; preds = %118, %102, %89, %79
  call void @perror(ptr noundef nonnull @.str.7) #16, !dbg !365
  call void @exit(i32 noundef 1) #15, !dbg !365
  unreachable, !dbg !365
...
88:                                               ; preds = %131, %115, %99, %85
  call void @perror(ptr noundef nonnull @.str.8) #16, !dbg !371
  call void @exit(i32 noundef 1) #15, !dbg !371
  unreachable, !dbg !371
...
89:                                               ; preds = %85
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %6) #14, !dbg !376
    #dbg_value(i64 1, !255, !DIExpression(), !296)
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %6) #14, !dbg !361
  %96 = load i64, ptr %48, align 8, !dbg !362, !tbaa !354
  %97 = call i32 @pthread_join(i64 noundef %96, ptr noundef nonnull %6) #14, !dbg !362
...
102:                                              ; preds = %99
  ...
  %113 = call i32 @pthread_join(i64 noundef %112, ptr noundef nonnull %6) #14, !dbg !362
...
118:                                              ; preds = %115
  ...
  %129 = call i32 @pthread_join(i64 noundef %128, ptr noundef nonnull %6) #14, !dbg !362
...
134:                                              ; preds = %131
  ...
  call void @free(ptr noundef nonnull %36) #14, !dbg !382
  ...
  %187 = call i32 @pthread_attr_destroy(ptr noundef nonnull %4) #14, !dbg !405
  %188 = icmp slt i32 %187, 0, !dbg !405
  br i1 %188, label %189, label %190, !dbg !407

189:                                              ; preds = %134
  call void @perror(ptr noundef nonnull @.str.20) #16, !dbg !408
  call void @exit(i32 noundef 1) #15, !dbg !408
  unreachable, !dbg !408

190:                                              ; preds = %134
  %191 = call i32 @munmap(ptr noundef nonnull %25, i64 noundef %24) #14, !dbg !410
  %192 = icmp slt i32 %191, 0, !dbg !410
  br i1 %192, label %193, label %194, !dbg !412

193:                                              ; preds = %190
  call void @perror(ptr noundef nonnull @.str.21) #16, !dbg !413
  call void @exit(i32 noundef 1) #15, !dbg !413
  unreachable, !dbg !413

194:                                              ; preds = %190
  %195 = call i32 @close(i32 noundef %14) #14, !dbg !415
  %196 = icmp slt i32 %195, 0, !dbg !415
  br i1 %196, label %197, label %198, !dbg !417

197:                                              ; preds = %194
  call void @perror(ptr noundef nonnull @.str.22) #16, !dbg !418
  call void @exit(i32 noundef 1) #15, !dbg !418
  unreachable, !dbg !418

198:                                              ; preds = %194
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %5) #14, !dbg !420
  call void @llvm.lifetime.end.p0(i64 56, ptr nonnull %4) #14, !dbg !420
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %3) #14, !dbg !420
  ret i32 0, !dbg !421
}
